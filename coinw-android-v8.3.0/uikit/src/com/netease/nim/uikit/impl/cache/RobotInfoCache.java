...
public class RobotInfoCache {
    ...
    public void buildCache() {
        ...
        //04-17 10:16:22.045 E/AndroidRuntime(26623): FATAL EXCEPTION: main
        //04-17 10:16:22.045 E/AndroidRuntime(26623): Process: huolongluo.byw, PID: 26623
        //04-17 10:16:22.045 E/AndroidRuntime(26623): java.lang.NullPointerException: Attempt to invoke interface method 'java.util.Iterator java.util.List.iterator()' on a null object reference
        //04-17 10:16:22.045 E/AndroidRuntime(26623): 	at com.netease.nim.uikit.impl.cache.RobotInfoCache.buildCache(RobotInfoCache.java:50)
        //04-17 10:16:22.045 E/AndroidRuntime(26623): 	at com.netease.nim.uikit.impl.cache.DataCacheManager.buildDataCache(DataCacheManager.java:71)
        //04-17 10:16:22.045 E/AndroidRuntime(26623): 	at com.netease.nim.uikit.impl.NimUIKitImpl.loginSuccess(NimUIKitImpl.java:269)
        //04-17 10:16:22.045 E/AndroidRuntime(26623): 	at com.netease.nim.uikit.impl.NimUIKitImpl$1.onSuccess(NimUIKitImpl.java:250)
        //04-17 10:16:22.045 E/AndroidRuntime(26623): 	at com.netease.nim.uikit.impl.NimUIKitImpl$1.onSuccess(NimUIKitImpl.java:243)
        if (robots == null) {
            LogUtil.e(UIKitLogTag.ROBOT_CACHE, "build RobotInfoCache error, robots count = " + robotMap.size());
            return;
        }
