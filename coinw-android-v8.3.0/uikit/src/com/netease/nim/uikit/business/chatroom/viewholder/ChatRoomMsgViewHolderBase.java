...
public abstract class ChatRoomMsgViewHolderBase extends RecyclerViewHolder<BaseMultiItemFetchLoadAdapter,
    ...
    private TextView avatarLeftTx;
    private TextView avatarRightTx;
...
//        avatarRight = findViewById(R.id.message_item_portrait_right);
        avatarLeftTx = findViewById(R.id.message_item_portrait_left);
        avatarRightTx = findViewById(R.id.message_item_portrait_right);
    ...
    private void setHeadImageView() {
        TextView show = isReceivedMessage() ? avatarLeftTx : avatarRightTx;
        TextView hide = isReceivedMessage() ? avatarRightTx : avatarLeftTx;
...
//        HeadImageView hide = isReceivedMessage() ? avatarRight : avatarLeft;
        ...
        if (isMiddleItem()) {
            ...
            if (show.getId() == R.id.message_item_portrait_left) {
                if (!TextUtils.isEmpty(P2PMessageActivity.adUserName)) {
                    show.setText(P2PMessageActivity.adUserName.substring(0, 1));
                }
            } else {
                show.setText("我");
            }
//            show.loadBuddyAvatar(message);
    ...
    private void setOnClickListener() {
        ...
        if (NimUIKitImpl.getSessionListener() != null) {
            ...
            avatarLeftTx.setOnClickListener(portraitListener);
            avatarRightTx.setOnClickListener(portraitListener);
        }
    }
    ...
    private void setLongClickListener() {
        ...
        if (NimUIKitImpl.getSessionListener() != null) {
            ...
            avatarLeftTx.setOnLongClickListener(longClickListener);
            avatarRightTx.setOnLongClickListener(longClickListener);
        }
    }
