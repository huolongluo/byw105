...
public class ElementParseHelper {
    ...
    public static List<Element> getElements(org.jsonx.JSONObject rootJsonObject) throws JSONException {
        ...
        while (keys.hasNext()) {
            ...
            if (o instanceof org.jsonx.JSONObject) {
                parseElement((org.jsonx.JSONObject) o, tag, elements);
    ...
    private static void parseElement(final org.jsonx.JSONObject obj, final String tag, final List<Element> elements) throws JSONException {
        Element e = null;
        switch (tag) {
