...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        super(context);
        final View view = View.inflate(context, R.layout.pop_folders, null);
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                //10-17 21:08:31.092 E/AndroidRuntime(32088): FATAL EXCEPTION: main
                //10-17 21:08:31.092 E/AndroidRuntime(32088): Process: huolongluo.byw, PID: 32088
                //10-17 21:08:31.092 E/AndroidRuntime(32088): java.lang.NoSuchFieldError: No static field masker of type I in class Lcom/lzy/imagepicker/R_id; or its superclasses (declaration of 'com.lzy.imagepicker.R_id' appears in /data/app/huolongluo.byw-1/base.apk:classes22.dex)
                //10-17 21:08:31.092 E/AndroidRuntime(32088): at com.lzy.imagepicker.view.FolderPopUpWindow.<init>(FolderPopUpWindow.java:41)
//                try {
