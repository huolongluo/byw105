...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setIsNeedCheckServiceStop(boolean isServiceStop){
        this.isServiceStop=isServiceStop;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_tab_flyco, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.layout_tab_flyco, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    static class InnerPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position < 0 || fragments == null || fragments.isEmpty()) {
                return null;
            }
