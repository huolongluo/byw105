...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_second_track_size, mTrackSize);
        mThumbRadius = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_radius, mSecondTrackSize + dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_radius_on_dragging, mSecondTrackSize + dp2px(2));
        ...
        isShowSectionMark = a.getBoolean(R.styleable.BubbleSeekBar_bsb_show_section_mark, true);
    ...
    private void initConfigByPriority() {
        ...
        mThumbTextSize = isFloatType || isSeekBySection || (isShowSectionText && mSectionTextPosition == TextPosition.BELOW_SECTION_MARK) ? mSectionTextSize : mThumbTextSize;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = (mSecondTrackSize + dp2px(4)); // 默认高度为拖动时thumb圆的直径
        if (isShowThumbText) {
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowThumbText && !isThumbOnDragging && isTouchToSeekAnimEnd) {
            ...
            if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == TextPosition.BOTTOM_SIDES && mProgress != mMin && mProgress != mMax)) {
       ...
       /* mPaint.setColor(mSecondTrackColor);
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            ...
            float r = (mSecondTrackSize / 2) + dp2px(1);
            //    float r = mThumbRadiusOnDragging;
            ...
            for (int i = 0; i <= mSectionCount; i++) {
               ...
               /* mPaint1=mPaint;
                if (isRtl) {
                    mPaint1.setColor(x_ <= junction ? getContext().getResources().getColor(R.color.ff1d1d333) : mSecondTrackColor);
                } else {
                    mPaint1.setColor(x_ <= junction ? mSecondTrackColor : getContext().getResources().getColor(R.color.ff1d1d333));
                }

            //    mPaint1.setColor(getContext().getResources().getColor(R.color.colorAccent));
                canvas.drawCircle(x_, yTop, r, mPaint1);*/
       ...
       /* if (!isThumbOnDragging || isAlwaysShowBubble) {
        ...
        canvas.drawCircle(mThumbCenterX, yTop, (mSecondTrackSize / 2) + dp2px(4), mPaint);
        // draw thumb
        mPaint.setColor(mThumbColor);
        //  canvas.drawCircle(mThumbCenterX, yTop, isThumbOnDragging ? mT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        humbRadiusOnDragging : mThumbRadius, mPaint);
        canvas.drawCircle(mThumbCenterX, yTop, (mSecondTrackSize / 2) + dp2px(1), mPaint);
    }
                ...
                if (isAutoAdjustSectionMark) {
                    ...
                    if (isHideBubble) {
                        ...
                        postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                mBubbleView.animate().alpha(isAlwaysShowBubble ? 1f : 0f).setDuration(mAnimDuration).setListener(new AnimatorListenerAdapter() {
                                    @Override
                                    public void onAnimationEnd(Animator animation) {
                                        if (!isAlwaysShowBubble) {
                                            hideBubble();
