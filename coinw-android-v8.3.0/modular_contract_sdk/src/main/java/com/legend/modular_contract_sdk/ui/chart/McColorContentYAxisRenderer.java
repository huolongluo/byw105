...
/**
 * Created by gyx on 2017/7/25.
 * 为每个label设置颜色，把两端的label绘制在内容区域内
 */

public class McColorContentYAxisRenderer extends YAxisRenderer {
    ...
    public McColorContentYAxisRenderer(ViewPortHandler viewPortHandler, YAxis yAxis, Transformer trans) {
