...
public class McHisData {
    ...
    public McHisData(long date, double open, double high,double low, double close,  double vol, double turnover ) {
        this.open = open;
        this.close = close;
        this.high = high;
        this.low = low;
