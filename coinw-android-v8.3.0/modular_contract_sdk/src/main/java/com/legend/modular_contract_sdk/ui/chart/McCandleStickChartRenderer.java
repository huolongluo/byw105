...
public class McCandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public McCandleStickChartRenderer(CandleDataProvider chart, ChartAnimator animator,
...
//            int offsetY = (int) Utils.convertDpToPixel(1);
            ...
            String minString = NumberStringUtil.formatAmount(minValueD,digit);
            //计算显示位置
            ...
            String maxString =NumberStringUtil.formatAmount(maxValueD,digit);
