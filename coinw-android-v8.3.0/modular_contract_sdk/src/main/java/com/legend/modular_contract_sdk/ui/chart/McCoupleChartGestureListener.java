 ...
 */
public class McCoupleChartGestureListener implements OnChartGestureListener {
    private static final String TAG = McCoupleChartGestureListener.class.getSimpleName();
    ...
    private McOnLoadMoreListener mOnLoadMoreListener;
    private boolean isLoadMore = false;
    private OnAxisChangeListener listener;

    public McCoupleChartGestureListener(OnAxisChangeListener listener, BarLineChartBase srcChart, Chart... dstCharts) {
        this(srcChart, dstCharts);
        this.listener = listener;
    }

    public McCoupleChartGestureListener(BarLineChartBase srcChart, Chart... dstCharts) {
...
//        Log.d(TAG, "getHighestVisibleX  " +srcChart.getHighestVisibleX());
    ...
    public void setOnLoadMoreListener(McOnLoadMoreListener onLoadMoreListener) {
