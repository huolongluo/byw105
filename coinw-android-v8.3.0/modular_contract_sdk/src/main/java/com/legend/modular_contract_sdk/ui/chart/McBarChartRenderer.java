...
public class McBarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public McBarChartRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
...
//                mRenderPaint.setColor(dataSet.getColor(j / 4));
                ...
                if (!(data instanceof McHisData)) {
                    mRenderPaint.setColor(dataSet.getColor(entryForIndex.getY() > 0 ? 0 : 1));
                } else {
                    McHisData hisData = (McHisData) data;
                    // 如果有买量和卖量，比较买卖量来决定颜色
...
//            c.drawRect(mBarRect, mHighlightPaint);
            /*重写高亮*/
            mHighlightPaint.setStrokeWidth(Utils.convertDpToPixel(6f));
