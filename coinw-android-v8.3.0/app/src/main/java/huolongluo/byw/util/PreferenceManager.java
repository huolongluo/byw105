...
public final class PreferenceManager {
    ...
    public static final String PREF_TRADE_WARN_CONFIRM = "TradeWarnConfirm";
    ...
    public static final String ORDE_RCONFIRMATION = "OrderConfirmation";
    ...
    public static final String PREF_LINE_STATUS = "SwapLineStatus";
