...
public class ChartInfoViewHandler implements View.OnTouchListener {
    ...
    public ChartInfoViewHandler(BarLineChartBase chart, DismissInfoViewCallback dismissInfoViewCallback, ScrollToRightCallback scrollToRightCallback) {
        mChart = chart;
        ...
        mDetector = new GestureDetector(mChart.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                for (DataRenderer renderer : ((AppCombinedChartRenderer) mChart.getRenderer()).getSubRenderers()) {
