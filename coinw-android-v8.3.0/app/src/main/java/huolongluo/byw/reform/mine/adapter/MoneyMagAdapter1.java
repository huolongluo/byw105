 ...
 */
public class MoneyMagAdapter1 extends BaseMoneyMagAdapter {
    public List<ByperpayBean.LicaiBean> list = new ArrayList<>();
    public Context context;
    private String imageUrl = "https://www.hyperpay.tech/data/upload/";

    public MoneyMagAdapter1(CheckHppClick click, List<ByperpayBean.LicaiBean> list, Context context) {
    ...
    public BaseMoneyMagAdapter.ViewHole onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_moneymanager_item1, parent, false);
