 ...
 */
public class MoneyMagAdapter2 extends BaseMoneyMagAdapter {
    public List<ByperpayBean.LicaiBean> list = new ArrayList<>();
    public Context context;
    private String imageUrl = "https://www.hyperpay.tech/data/upload/";

    public MoneyMagAdapter2(CheckHppClick click, List<ByperpayBean.LicaiBean> list, Context context) {
    ...
    public BaseMoneyMagAdapter.ViewHole onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_moneymanager_item2, parent, false);
    ...
    public void onBindViewHolder(BaseMoneyMagAdapter.ViewHole holder, int position) {
        ...
        holder.miaoshu_tv.setText(list.get(position).getKeywords());
