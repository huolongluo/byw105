...
public class OtcOrderShopsManagerActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otcshop_ordermanager);
        ...
        otcFragmentBuy = OtcOrderMainagerBuyFragment.newInStance(2);
    ...
    void switchs(int page) {
        ...
        if (page == 0) {
            ...
            if (otcFragmentSell == null) {
                ...
                otcFragmentSell = OtcOrderMainagerSellFragment.newInStance(2);
    ...
    void initTitle() {
        ...
        tab1.setTag(0);
        View view1 = View.inflate(this, R.layout.search_tab_item2, null);
        ...
        zixuanview.setText(R.string.cx1);
        ...
        tab2.setTag(1);
        View view2 = View.inflate(this, R.layout.search_tab_item2, null);
        ...
        zixuanview2.setText(R.string.cx2);
