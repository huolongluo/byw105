...
public class THistoryFragment extends BaseFragment{
    ...
    public static THistoryFragment getInstance()
    {
        Bundle args = new Bundle();
        THistoryFragment fragment = new THistoryFragment();
...
//        lv_content.setOnItemClickListener(itemClickListener);
        ...
        lv_content.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("recharge_virtual_address",mData1.get((int) id).getRecharge_virtual_address());//充值地址
    ...
    private void getData(){
        ...
        String body = "id="+ URLEncoder.encode("-1")+"&ftype=" +URLEncoder.encode("2")+"&currentPage=" +URLEncoder.encode(mHelper.getPage()+"");
        try {
...
//        parmas.put("currentPage", String.valueOf(currentPage));
        netTags.add(UrlConstants.DOMAIN + UrlConstants.GET_RECHARGELIST);
...
//                            if (bean.getList().get(i).getFtype().equals("2")) {
