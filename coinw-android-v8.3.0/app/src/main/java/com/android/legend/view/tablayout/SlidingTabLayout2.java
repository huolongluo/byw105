...
public class SlidingTabLayout2 extends HorizontalScrollView {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorHeight = ta.getDimension(com.flyco.tablayout.R.styleable.SlidingTabLayout_tl_indicator_height, dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 4 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
        ...
        mSelectTextSize = ta.getDimension(com.flyco.tablayout.R.styleable.SlidingTabLayout_tl_textSelectsize, sp2px(14));
//        mTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textsize, dp2px(14));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, com.flyco.tablayout.R.layout.layout_tab_flyco, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, com.flyco.tablayout.R.layout.layout_tab_flyco, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void scrollToCurrentTab() {
        if (mTabCount <= 0||mTabsContainer==null||mTabsContainer.getChildAt(mCurrentTab)==null) {
            return;
        }
