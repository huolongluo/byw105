package com.android.legend.view.framelayout;
...
public class SkinMarqueeView<T> extends ViewFlipper {
    ...
    public SkinMarqueeView(Context context) {
        this(context, null);
    }

    public SkinMarqueeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = typedArray.getResourceId(R.styleable.MarqueeViewStyle_mvTextColor, textColor);
