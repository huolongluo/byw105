...
public class KeyboardManager {
    ...
    public KeyboardManager(Context context) {
        ...
        if (mContext instanceof Activity) {
            mRootView = ((Activity) context).getWindow().getDecorView().findViewById(android.R.id.content);
    ...
    public void resh(int type){
        mKeyboardWithSearchView.fresh( type);
    }
    ...
    public void bindToEditor(EditText editText, BaseKeyboard keyboard) {
        ...
        editText.setOnClickListener(editorClickListener);
    }
...
//        mRootView.getViewTreeObserver().addOnGlobalLayoutListener(mOnGlobalLayoutListener);
    ...
    public void hideSoftKeyboard() {
       ...
       public boolean isShow(){
        ...
        return mKeyboardWithSearchView.getVisibility() != View.GONE;
