...
public abstract class BaseKeyboard extends Keyboard implements KeyboardView.OnKeyboardActionListener{
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        if(null != mEditText && mEditText.hasFocus() && !handleSpecialKey(primaryCode,keyCodes)) {
     ...
     */
    public abstract boolean handleSpecialKey(int primaryCode, int[] keyCodes);

    public interface KeyStyle {

        Drawable getKeyBackound(Key key);
