...
public abstract class LineScatterCandleRadarDataSet<T extends Entry> extends BarLineScatterCandleBubbleDataSet<T> implements ILineScatterCandleRadarDataSet<T> {
    ...
    protected float mHighlightHorizontalLineWidth = 0.5f;
    ...
    public void setHighlightHorizontalLineWidth(float width) {
        mHighlightHorizontalLineWidth = Utils.convertDpToPixel(width);
    }

    @Override
    public float getHighlightHorizontalLineWidth() {
        return mHighlightHorizontalLineWidth;
    }
