...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private boolean mDrawLastCircles = false;
    ...
    public void setDrawLastCircles(boolean enabled) {
        this.mDrawLastCircles = enabled;
    }

    @Override
    public boolean isDrawLastCirclesEnabled() {
